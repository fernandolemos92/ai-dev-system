---
description: Design-system specialist for DESIGN.md, tokens, component standards, semantic visual language, and UI consistency.
mode: subagent
permission:
  edit: allow
  bash:
...
- semantic tokens as the implementation API
